...
// Universe is a two-dimensional fields of cells
type Universe [][]bool
...
// If the coordinated are outside of the universe,  they wrap around
...
// Neighbour counts the adjacent cells that are alive
